# zr ohmyzsh/ohmyzsh.git/plugins/vi-mode
# . <(zr ohmyzsh/ohmyzsh.git/plugins/autojump/autojump.plugin.zsh ohmyzsh/ohmyzsh.git/plugins/vi-mode/vi-mode.plugin.zsh ohmyzsh/ohmyzsh.git/plugins/macos/macos.plugin.zsh)
